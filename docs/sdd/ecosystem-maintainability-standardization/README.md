...
Settings QML is app-owned and its public configuration package has consumer responsibilities, but local/system uninstall tasks duplicate lifecycle policy and package ownership needs a sharper boundary from holonight-config.
