...
struct AppearanceConfig {
  QString ui_font{"Inter"};
  int ui_font_size{12};
  QString fixed_font{"JetBrains Mono"};
  int fixed_font_size{12};
  QString clock_font{"Rajdhani"};
  int clock_font_size{24};
  QString title_font{"Audiowide"};
  int title_font_size{8};
  int transparency{100};
  int blur_strength{0};
  static constexpr int kMinTransparency{0};
  static constexpr int kMaxTransparency{100};
  static constexpr int kMinBlurStrength{0};
  static constexpr int kMaxBlurStrength{64};
